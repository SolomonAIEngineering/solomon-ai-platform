...
export const metadata: Metadata = {
    title: "Merchant Analytics | Solomon AI",
};
...
export default function MerchantAnalytics() {
    ...
    return (
        <EmptyStatePane images={images} title={"Financial Analytics (Merchant)"}>
            <p className="text-sm text-[#878787]">
                Soon we’ll be releasing our financial analytics feature offering,<br />
                which provides merchant level insights sourced directly<br />
