      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            ...
            your relationship with Solomon AI application (the "Service") operated
            by Solomon AI ("us", "we", or "our").
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            cancel it or Solomon AI cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting Solomon AI customer support team.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            you automatically authorize Solomon AI to charge all
            Subscription fees incurred through your account to any such payment
            instruments.
          </p>

          <p className="leading-7 mt-8">
            Should automatic billing fail to occur for any reason, Solomon AI Labs
          ...
          <p className="leading-7 mt-8">
            Solomon AI, in its sole discretion and at any time, may modify
          ...
          <p className="leading-7 mt-8">
            Solomon AI will provide you with a reasonable prior notice of
          ...
          <p className="leading-7 mt-8">
            ...
            property of Solomon AI and its licensors. The Service is
          ...
          <p className="leading-7 mt-8">
            Solomon AI has no control over, and assumes no responsibility
          ...
          <p className="leading-7 mt-8">
            Solomon AI its subsidiaries, affiliates, and its licensors do
