...
export function Header() {
  ...
  const links = [
    ...
    },
    {
      ...
      children: [
        {
          path: "https://github.com/SolomonAIEngineering/solomon-ai-platform",
          title: "Open Source",
  ...
  return (
    ...
    >
      <nav className="rounded-2xl border border-border px-4 flex items-center backdrop-filter backdrop-blur-xl bg-[#121212] bg-opacity-70 h-[50px] z-20">
        <ContextMenu>
          <ContextMenuTrigger>
            <Link href="/">
            ...
            return (
              ...
              >
                ...
                {children && (
                  <div
                    className={cn(
                      "absolute top-[48px] w-[676px] -left-[1px] bg-[#121212] flex h-0 group-hover:h-[250px] overflow-hidden transition-all duration-300 ease-in-out border-l-[1px] border-r-[1px] rounded-2xl mt-[2%]",
                      hidden && "hidden"
                    )}
                  >
